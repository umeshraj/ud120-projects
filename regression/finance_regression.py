...
print "Intercept is %f; Slope is %f" %(reg.intercept_, reg.coef_)

#training score
trainScore = reg.score(feature_train, target_train)
print "Score for training: %f" %trainScore

testScore = reg.score(feature_test, target_test)
print "Score for testing: %f" %testScore

# regressing bonus with long_term_incentive
